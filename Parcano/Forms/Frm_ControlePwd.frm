...
Begin VB.Form Frm_ControlePwd 
   ...
   Begin VB.Image img_background 
      Height          =   3975
      Left            =   0
      Picture         =   "Frm_ControlePwd.frx":0000
      Stretch         =   -1  'True
      Top             =   0
      Width           =   7335
   End
...
On Error GoTo Err
    ...
    If Lrs_User.Fields("actif") = 0 Then
    MsgBox ("Vous n'avez pas le droit d'accèder à cette interface")
    Exit Sub
    Else
        exist = True
        LInt_UserIdMaj = Lrs_User.Fields("Code")
    End If
    End If
